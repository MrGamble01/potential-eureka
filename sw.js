...
const SW_VERSION = 'eureka-v25';  // rolls Flagship Depth 122–127 (retro, mother plant, drillmaster, tool box, hunter's lodge, owl roost + these notes) to installed PWAs
