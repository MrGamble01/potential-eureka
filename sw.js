...
const SW_VERSION = 'eureka-v46';  // rolls Flagship Depth 269–274 (the six guest books: lobby book, wall of names, muster roll, spiral notebook, hall register, harbor log + these notes) to installed PWAs
