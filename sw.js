...
const SW_VERSION = 'eureka-v26';  // rolls Flagship Depth 129–134 (licensing desk, clientele, paymaster, compost bin, cider press, truffle pig + these notes) to installed PWAs
