...
const SW_VERSION = 'eureka-v39';  // rolls Flagship Depth 220–225 (brass plaque, gold record, laurel, chalk star, gilded page, shell wreath + these notes) to installed PWAs
