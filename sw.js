...
const SW_VERSION = 'eureka-v49';  // rolls Flagship Depth 290–296 (the six songs: anthem, block track, marching song, bridge ballad, minstrel's ballad, sea shanty + these notes) to installed PWAs
