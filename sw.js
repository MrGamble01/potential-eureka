...
const SW_VERSION = 'eureka-v50';  // rolls Flagship Depth 297–303 (the six capsules: time capsule, shoebox, cornerstone cache, coffee can, founders' casket, sunken chest + these notes) to installed PWAs
