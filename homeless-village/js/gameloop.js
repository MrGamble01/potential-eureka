...
function onNewDay(){
  ...
  if(G.workers.scrapper){ G.scraps+=rand(1,3); G.cans+=rand(0,2); var sf=Math.random()<SCRAPPER_FOOD_CHANCE?rand(1,3):0; if(sf) G.food+=sf; log('The Scrapper found some supplies.'+(sf?(' +'+sf+' food.'):'')); }
