...
var RECIPES = [
  ...
  {id:'awning',      icon:'\u26F1\uFE0F', name:'Awning',          cost:{scraps:4,cans:2},                gives:{structure:'awning'},     time:8000,  desc:'A salvaged shop awning rigged over the corner \u2014 rain no longer halves the take; the corner keeps clear-day odds.', requires:'workbench'},
