...
var RECIPES = [
  ...
  {id:'soup_kitchen',icon:'🍲', name:'Soup Kitchen',   cost:{wood:10,scraps:8,cans:5,goodwill:5}, gives:{structure:'soup_kitchen'}, time:15000, desc:'Soup night: feeds everyone at dawn (1 food each) for +4 morale, +2 health — and neighbors sometimes chip in.', requires:'workbench'},
