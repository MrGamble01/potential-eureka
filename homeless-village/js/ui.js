function buildActionUI(){
  ...
  if(dryAvailable()){
    ...
    dyb.innerHTML='<span class="btn-progress" id="progress-dry" style="width:0%"></span>'+dya.icon+' '+dya.label+(linkDoneToday('dry')&&dryBuilt()?' \u2713':'');
    if(linkDoneToday('dry')&&dryBuilt()){ dyb.disabled=true; dyb.style.opacity='.5'; }
