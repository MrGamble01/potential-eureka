...
function finishAction(a){
  ...
  if(a.id==='scavenge'){
    ...
    // HV-76: Gentrification halves the corner until dawn.
    var gentrifyCut=gentrifyHostile()?GENTRIFY_PAN:1;
    if(Math.random()<.55*weatherDef().pan*awningDry*dogBoost*repBoost*muralBoost*snapCut*gentrifyCut){ var g=rand(1,4); G.goodwill+=g; floatText('+'+g+'🩶'); log('Someone gave you a few coins. +'+g+' goodwill.');
