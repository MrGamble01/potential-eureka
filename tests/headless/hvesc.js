 ...
 * dialog. × and backdrop already dismiss it. Escape was only wired for
 * the HV-56 first-run intro, which keys off #intro-modal and never sees
...
// Source guard: the handler must close #chain-modal and must not ride
