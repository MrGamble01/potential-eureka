/* HV-72 — the event banner pauses the day clock.
 *
 ...
 * different overlay — not HV-68 (Escape) and not HV-64 (Keys pause).
 *
...
(async () => {
  ...
  ok(held.open && held.tod === parked.tod && held.days === parked.days && held.warmth === parked.warmth,
    `HV-72: the day is paused behind the event banner (tod ${parked.tod}->${held.tod}, days ${parked.days}->${held.days}, warmth ${parked.warmth}->${held.warmth})`);
