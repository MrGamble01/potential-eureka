 ...
 *
 * A cold snap sky now halves the lift. Heat keeps HV-247’s 0.75 cut.
 * Flyers pay in full; the scrapyard keeps HV-189’s cold half haul.
 ...
 *  D. Clear / rain pay +5; heat pays +3 (HV-247).
...
(async () => {
  ...
  // D — clear / rain keep +5; heat keeps HV-247’s +3
  ...
  ok(heat.goodwill === 13,
    `HV-247: a scorcher lift still pays +3 (10 → ${heat.goodwill})`);
  ...
  ok(scrap.job === 'scrapyd' && scrap.scraps === 2 && scrap.cans === 1,
    `HV-189: the scrapyard still halves its cold haul (${scrap.scraps}/${scrap.cans})`);
