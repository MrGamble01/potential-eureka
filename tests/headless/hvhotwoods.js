...
(async () => {
  ...
  ok(rain.wood >= 1 && rain.wood <= 4 && rain.card >= 1 && rain.card <= 3,
    `a rainy day still pays, at HV-198's soaked cardboard — not this card's refusal (wood=${rain.wood}, card=${rain.card})`);
