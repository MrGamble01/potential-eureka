...
| Startup Tycoon | `tycbusy` (TYC-61: timed-offer spawners treat The Wall — and Help, Dashboard, Achievements, Elevator — as busy, the same way they already treat Founder Shop. Reverting `#wall-modal.open` from any gate fails that spawner by name) |
