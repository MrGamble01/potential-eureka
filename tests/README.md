...
| Hub games | `undo2048`, `w5share`, `cycles3`, `c4think` (C4-1: Drop Four's AI think delay dies with the board that armed it — New Game, a mode switch and a difficulty switch mid-think no longer let the AI open the fresh game or swallow the disc you just dropped) |
