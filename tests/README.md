...
| Area | Suites |
|---|---|
| Voxel tavern meal report | `voxtavern` (hook-free: next-meal ETA, next good, goods remaining, meals served, villager tables, empty-kitchen wait, read-only taps at 1280px/768px, zero page errors) |
