...
| Hub games | `undo2048`, `w5share`, `cycles3`, `crate` (CRATE-1: the ladder survives a view switch — reads the board off the canvas and BFS-solves it, since the game module exposes only its controls) |
