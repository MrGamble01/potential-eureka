...
| Area | Suites |
|---|---|
| Voxel Isle owl roost inspect | `voxowl` (hook-free: real mesh taps, daytime hunt tally, advancing rounded-up night ETA, wet/dry pay, unchanged tap economy/timer, daylight hold, sibling description and zero page errors) |
