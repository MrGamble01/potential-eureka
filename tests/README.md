...
| Hub games | `undo2048`, `w5share`, `cycles3`, `crateleave` (CRATE-1: a solved Crate Escape puzzle survives a view switch — the win overlay and the `solvedNow` flag SPACE/Enter/tap all depend on) |
