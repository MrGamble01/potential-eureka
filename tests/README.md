...
| Hearthvale beacon panel | `hvalebeacon` (hook-free: road protection, zero/singular/plural watchfire counts, well/construction isolation, unchanged saved state, 1280px/768px, zero page errors) |
