...
| Area | Suites |
|---|---|
| Voxel Isle preserve shelf | `voxjam` (hook-free: seeded built shed, mid-shelf dawn and full-shelf festival toasts, read-only taps at 1280px/768px, zero page errors; retains Preserve Shed economy checks) |
