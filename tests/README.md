...
| Hub games | `undo2048`, `w5share`, `cycles3`, `mazesolve` (MAZE-1: the runner regains control once "Watch AI Solve" finishes, not just before it — checked for both BFS and A*) |
