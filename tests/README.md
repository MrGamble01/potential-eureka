...
| Area | Suites |
|---|---|
| Voxel Isle corn crib inspect | `voxcribmeals` (hook-free: real building meshes report zero/live blunted raids and permanent peck reduction, unchanged coins/meals, generic vane description, zero page errors) |
