...
| Area | Suites |
|---|---|
| Grow Op grow ETA | `labgroweta` (hook-free: production plot state and page-clock time, rounded-up live seconds, lights/night-shift speed changes, Ready pulse, empty plots, harvest clearing and zero page errors) |
