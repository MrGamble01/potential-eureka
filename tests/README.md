...
| Hub games | `undo2048`, `w5share`, `cycles3`, `lifestable` (P8-LIFE-1: Game of Life auto-pauses on a repeat — an oscillator's period or extinction — and writes why to `#life-status`) |
