...
| Age of War | `aowbanner` (AOW-19b: the war-banner pill row keeps showing which banner is in force when the difficulty changes, and stays styled like — but separate from — the difficulty pills) |
