...
| Hub games | `undo2048`, `w5share`, `cycles3`, `pongkeys` (PONG-1: Pong’s key map survives leaving the view — a held key released after you navigate away, or lost to a window blur, no longer drifts a paddle; 1P W/S + arrows and the 2P split bindings guarded alongside) |
