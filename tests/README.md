...
- `voxchrome` (return chrome leftovers: shared Games pill, Let's grow + hub exit, resume chip, 768×700 quest/tool split, Achievements/Almanac/Shore Games, corrupt-garden chip, New isle, tray above the hotbar, plant sheet tucks the tray, resume-chip New isle)
