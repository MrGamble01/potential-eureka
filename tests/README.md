...
| Hub games | `undo2048`, `w5share`, `cycles3`, `cratereturn` (CE-1: Crate Escape solves a level with the arrow keys a player presses, then leaves and returns — a solved board must not still be sitting there) |
