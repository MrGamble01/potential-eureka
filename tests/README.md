...
| Hearthvale palisade panel | `hvalepalisade` (hook-free: sleepless +1 and live town watch, staffed/unattended towers, construction/well exclusions, unchanged buildings/gold/watch state, 1280px/768px; zero page errors) |
